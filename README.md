# Typechecker
![build status](https://github.com/RTomori/Typechecker/actions/workflows/WORKFLOW-FILE/badge.svg)
Milner-Mycroft計算の決定可能な断片($\vdash_{0}^{k,ML}$，[1]pp.7-10)の実装．
## Provisos
GHC9.10.3, 9.12.3およびhappy ver.1.20.1.1で動作確認済．buildにはstackまたはcabalを用いる．
